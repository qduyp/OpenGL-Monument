				   ...
				   const char* tessevaluationFilePath, const char* computeFilePath)
{
	...
	{
		printf("Failed to open vertex shader source!\n");
	}
	if (vsavailable)
	{
	...
	{
		printf("Failed to open fragment shader source!\n");
	}
	if (fsavailable)
	{
	...
	{
		printf("Failed to open geometry shader source!\n");
	}
	if (gsavailable)
	{
	...
	{
		printf("Failed to open tesscontrol shader source!\n");
	}
	if (tcsavailable)
	{
	...
	{
		printf("Failed to open tessevaluation shader source!\n");
	}
	if (tesavailable)
	{
	...
	{
		printf("Failed to open compute shader source!\n");
	}
	if (cosavailable)
	{
